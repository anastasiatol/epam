...
export class AddMovieForm extends Component {
    ...
    render() {
        return (
            <form className = {this.props.addMovieIsOpen? 'ak-addmovieform ak-addmovieform__flex ak-maininformation_addmovieform': 'ak-addmovieform ak-addmovieform__none ak-maininformation_addmovieform'} 
                action = '' 
                method = ''
                >
